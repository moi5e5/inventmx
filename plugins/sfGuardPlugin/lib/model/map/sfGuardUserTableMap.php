...
class sfGuardUserTableMap extends TableMap {
    ...
    $this->addRelation('Blog', 'Blog', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('MensajeRelatedByDestinatarioId', 'Mensaje', RelationMap::ONE_TO_MANY, array('id' => 'destinatario_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('MensajeRelatedByRemitenteId', 'Mensaje', RelationMap::ONE_TO_MANY, array('id' => 'remitente_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Post', 'Post', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Comentario', 'Comentario', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('RedSocialXPerfil', 'RedSocialXPerfil', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
