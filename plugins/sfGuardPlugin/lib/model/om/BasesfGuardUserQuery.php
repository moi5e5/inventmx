 ...
 *
 * @method     sfGuardUserQuery leftJoinBlog($relationAlias = null) Adds a LEFT JOIN clause to the query using the Blog relation
 * @method     sfGuardUserQuery rightJoinBlog($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Blog relation
 * @method     sfGuardUserQuery innerJoinBlog($relationAlias = null) Adds a INNER JOIN clause to the query using the Blog relation
 *
 * @method     sfGuardUserQuery leftJoinMensajeRelatedByDestinatarioId($relationAlias = null) Adds a LEFT JOIN clause to the query using the MensajeRelatedByDestinatarioId relation
 * @method     sfGuardUserQuery rightJoinMensajeRelatedByDestinatarioId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the MensajeRelatedByDestinatarioId relation
 * @method     sfGuardUserQuery innerJoinMensajeRelatedByDestinatarioId($relationAlias = null) Adds a INNER JOIN clause to the query using the MensajeRelatedByDestinatarioId relation
 *
 * @method     sfGuardUserQuery leftJoinMensajeRelatedByRemitenteId($relationAlias = null) Adds a LEFT JOIN clause to the query using the MensajeRelatedByRemitenteId relation
 * @method     sfGuardUserQuery rightJoinMensajeRelatedByRemitenteId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the MensajeRelatedByRemitenteId relation
 * @method     sfGuardUserQuery innerJoinMensajeRelatedByRemitenteId($relationAlias = null) Adds a INNER JOIN clause to the query using the MensajeRelatedByRemitenteId relation
 *
 * @method     sfGuardUserQuery leftJoinPost($relationAlias = null) Adds a LEFT JOIN clause to the query using the Post relation
 * @method     sfGuardUserQuery rightJoinPost($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Post relation
 * @method     sfGuardUserQuery innerJoinPost($relationAlias = null) Adds a INNER JOIN clause to the query using the Post relation
 *
 * @method     sfGuardUserQuery leftJoinComentario($relationAlias = null) Adds a LEFT JOIN clause to the query using the Comentario relation
 * @method     sfGuardUserQuery rightJoinComentario($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Comentario relation
 * @method     sfGuardUserQuery innerJoinComentario($relationAlias = null) Adds a INNER JOIN clause to the query using the Comentario relation
 *
 * @method     sfGuardUserQuery leftJoinRedSocialXPerfil($relationAlias = null) Adds a LEFT JOIN clause to the query using the RedSocialXPerfil relation
 * @method     sfGuardUserQuery rightJoinRedSocialXPerfil($relationAlias = null) Adds a RIGHT JOIN clause to the query using the RedSocialXPerfil relation
 * @method     sfGuardUserQuery innerJoinRedSocialXPerfil($relationAlias = null) Adds a INNER JOIN clause to the query using the RedSocialXPerfil relation
 *
...
abstract class BasesfGuardUserQuery extends ModelCriteria
{
	...
	{
		return $this
			->addUsingAlias(sfGuardUserPeer::ID, $blog->getUserId(), $comparison);
	}
	 ...
	 * @return    sfGuardUserQuery The current query, for fluid interface
	 */
	public function filterByMensajeRelatedByDestinatarioId($mensaje, $comparison = null)
	{
		return $this
			->addUsingAlias(sfGuardUserPeer::ID, $mensaje->getDestinatarioId(), $comparison);
	}

	/**
	 * Adds a JOIN clause to the query using the MensajeRelatedByDestinatarioId relation
	 * 
	 * @param     string $relationAlias optional alias for the relation
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    sfGuardUserQuery The current query, for fluid interface
	 */
	public function joinMensajeRelatedByDestinatarioId($relationAlias = null, $joinType = Criteria::INNER_JOIN)
	{
		$tableMap = $this->getTableMap();
		$relationMap = $tableMap->getRelation('MensajeRelatedByDestinatarioId');
		...
		if($relationAlias) {
			...
			$this->addJoinObject($join, 'MensajeRelatedByDestinatarioId');
		}
	...
	/**
	 * Use the MensajeRelatedByDestinatarioId relation Mensaje object
	 *
	 * @see       useQuery()
	 * 
	 * @param     string $relationAlias optional alias for the relation,
	 ...
	 */
	public function useMensajeRelatedByDestinatarioIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
	{
		return $this
			->joinMensajeRelatedByDestinatarioId($relationAlias, $joinType)
			->useQuery($relationAlias ? $relationAlias : 'MensajeRelatedByDestinatarioId', 'MensajeQuery');
	}
	 ...
	 * @return    sfGuardUserQuery The current query, for fluid interface
	 */
	public function filterByMensajeRelatedByRemitenteId($mensaje, $comparison = null)
	{
		return $this
			->addUsingAlias(sfGuardUserPeer::ID, $mensaje->getRemitenteId(), $comparison);
	}

	/**
	 * Adds a JOIN clause to the query using the MensajeRelatedByRemitenteId relation
	 * 
	 * @param     string $relationAlias optional alias for the relation
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    sfGuardUserQuery The current query, for fluid interface
	 */
	public function joinMensajeRelatedByRemitenteId($relationAlias = null, $joinType = Criteria::INNER_JOIN)
	{
		$tableMap = $this->getTableMap();
		$relationMap = $tableMap->getRelation('MensajeRelatedByRemitenteId');
		...
		if($relationAlias) {
			...
			$this->addJoinObject($join, 'MensajeRelatedByRemitenteId');
		}
	...
	/**
	 * Use the MensajeRelatedByRemitenteId relation Mensaje object
	 *
	 * @see       useQuery()
	 * 
	 * @param     string $relationAlias optional alias for the relation,
	 ...
	 * @return    MensajeQuery A secondary query class using the current class as primary query
	 */
	public function useMensajeRelatedByRemitenteIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
	{
		return $this
			->joinMensajeRelatedByRemitenteId($relationAlias, $joinType)
			->useQuery($relationAlias ? $relationAlias : 'MensajeRelatedByRemitenteId', 'MensajeQuery');
	}
	...
	{
		return $this
			->addUsingAlias(sfGuardUserPeer::ID, $post->getUserId(), $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(sfGuardUserPeer::ID, $comentario->getUserId(), $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(sfGuardUserPeer::ID, $redSocialXPerfil->getUserId(), $comparison);
	}
