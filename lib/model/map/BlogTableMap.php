...
class BlogTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		// columns
		$this->addPrimaryKey('BLOG_ID', 'BlogId', 'INTEGER', true, null, null);
    ...
    $this->addRelation('BlogXTematica', 'BlogXTematica', RelationMap::ONE_TO_MANY, array('blog_id' => 'blog_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Post', 'Post', RelationMap::ONE_TO_MANY, array('blog_id' => 'blog_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Boletin', 'Boletin', RelationMap::ONE_TO_MANY, array('blog_id' => 'blog_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
