...
abstract class BaseComentarioPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('COMENTARIO_ID', 'USER_ID', 'POST_ID', 'COMENTARIO', 'RESPUESTA', 'CREATED_AT', ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('COMENTARIO_ID' => 0, 'USER_ID' => 1, 'POST_ID' => 2, 'COMENTARIO' => 3, 'RESPUESTA' => 4, 'CREATED_AT' => 5, ),
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn($alias . '.COMENTARIO_ID');
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = ComentarioPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + ComentarioPeer::NUM_COLUMNS;
		} else {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(ComentarioPeer::COMENTARIO_ID);
			if ($value) {
				$selectCriteria->add(ComentarioPeer::COMENTARIO_ID, $value, $comparison);
			} else {
