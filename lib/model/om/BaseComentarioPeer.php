...
abstract class BaseComentarioPeer {
	...
	/** the column name for the COMENTARIO_ID field */
	const COMENTARIO_ID = 'comentario.COMENTARIO_ID';

	/** the column name for the USER_ID field */
	const USER_ID = 'comentario.USER_ID';

	/** the column name for the POST_ID field */
	const POST_ID = 'comentario.POST_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ComentarioId', 'UserId', 'PostId', 'Comentario', 'Respuesta', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('comentarioId', 'userId', 'postId', 'comentario', 'respuesta', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::COMENTARIO_ID, self::USER_ID, self::POST_ID, self::COMENTARIO, self::RESPUESTA, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('comentario_id', 'user_id', 'post_id', 'comentario', 'respuesta', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ComentarioId' => 0, 'UserId' => 1, 'PostId' => 2, 'Comentario' => 3, 'Respuesta' => 4, 'CreatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('comentarioId' => 0, 'userId' => 1, 'postId' => 2, 'comentario' => 3, 'respuesta' => 4, 'createdAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::COMENTARIO_ID => 0, self::USER_ID => 1, self::POST_ID => 2, self::COMENTARIO => 3, self::RESPUESTA => 4, self::CREATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('comentario_id' => 0, 'user_id' => 1, 'post_id' => 2, 'comentario' => 3, 'respuesta' => 4, 'created_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		$criteria->addSelectColumn(ComentarioPeer::COMENTARIO_ID);
		$criteria->addSelectColumn(ComentarioPeer::USER_ID);
		$criteria->addSelectColumn(ComentarioPeer::POST_ID);
		$criteria->addSelectColumn(ComentarioPeer::COMENTARIO);
		$criteria->addSelectColumn(ComentarioPeer::RESPUESTA);
	 ...
	 */
	public static function addInstanceToPool(Comentario $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getComentarioId();
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Comentario) {
				$key = (string) $value->getComentarioId();
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ComentarioPeer::getOMClass(false);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ComentarioPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	public static function doCountJoinPost(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ComentarioPeer::POST_ID, PostPeer::POST_ID, $join_behavior);
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ComentarioPeer::addSelectColumns($criteria);
		$startcol = (ComentarioPeer::NUM_COLUMNS - ComentarioPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comentario) to $obj2 (sfGuardUser)
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with their Post objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Comentario objects.
	...
	public static function doSelectJoinPost(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comentario) to $obj2 (Post)
				$obj2->addComentario($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ComentarioPeer::addSelectColumns($criteria);
		$startcol2 = (ComentarioPeer::NUM_COLUMNS - ComentarioPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comentario) to the collection in $obj2 (sfGuardUser)
				$obj2->addComentario($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Comentario) to the collection in $obj3 (Post)
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with all related objects except sfGuardUser.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ComentarioPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Comentario) to the collection in $obj2 (Post)
				$obj2->addComentario($obj1);
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with all related objects except Post.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
		return $withPrefix ? ComentarioPeer::CLASS_DEFAULT : ComentarioPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Comentario or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseComentarioPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseComentarioPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(ComentarioPeer::COMENTARIO_ID) && $criteria->keyContainsValue(ComentarioPeer::COMENTARIO_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ComentarioPeer::COMENTARIO_ID.')');
		}
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseComentarioPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseComentarioPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Comentario or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseComentarioPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseComentarioPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ComentarioPeer::COMENTARIO_ID);
			$selectCriteria->add(ComentarioPeer::COMENTARIO_ID, $criteria->remove(ComentarioPeer::COMENTARIO_ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseComentarioPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseComentarioPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the comentario table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Comentario or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ComentarioPeer::COMENTARIO_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ComentarioPeer::COMENTARIO_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ComentarioPeer::DATABASE_NAME);
			$criteria->add(ComentarioPeer::COMENTARIO_ID, $pks, Criteria::IN);
