...
abstract class BaseComentario extends BaseObject  implements Persistent
{
  ...
  const PEER = 'ComentarioPeer';
	...
	/**
	 * The value for the comentario_id field.
	 * @var        int
	 */
	...
	/**
	 * Get the [comentario_id] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [comentario_id] column.
	 * 
	...
	public function setComentarioId($v)
	{
		...
		if ($this->comentario_id !== $v) {
			$this->comentario_id = $v;
			$this->modifiedColumns[] = ComentarioPeer::COMENTARIO_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = ComentarioPeer::USER_ID;
		}
	...
	public function setPostId($v)
	{
		...
		if ($this->post_id !== $v) {
			$this->post_id = $v;
			$this->modifiedColumns[] = ComentarioPeer::POST_ID;
		}
	...
	public function setRespuesta($v)
	{
		...
		if ($this->respuesta !== $v) {
			$this->respuesta = $v;
			$this->modifiedColumns[] = ComentarioPeer::RESPUESTA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->comentario_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 6; // 6 = ComentarioPeer::NUM_COLUMNS - ComentarioPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(ComentarioPeer::COMENTARIO_ID) ) {
						throw new PropelException('Cannot insert a value for auto-increment primary key ('.ComentarioPeer::COMENTARIO_ID.')');
					}

					$pk = BasePeer::doInsert($criteria, $con);
					$affectedRows += 1;
					$this->setComentarioId($pk);  //[IMV] update autoincrement primary key
					$this->setNew(false);
				} else {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setComentarioId($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ComentarioPeer::COMENTARIO_ID)) $criteria->add(ComentarioPeer::COMENTARIO_ID, $this->comentario_id);
		if ($this->isColumnModified(ComentarioPeer::USER_ID)) $criteria->add(ComentarioPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(ComentarioPeer::POST_ID)) $criteria->add(ComentarioPeer::POST_ID, $this->post_id);
		if ($this->isColumnModified(ComentarioPeer::COMENTARIO)) $criteria->add(ComentarioPeer::COMENTARIO, $this->comentario);
		if ($this->isColumnModified(ComentarioPeer::RESPUESTA)) $criteria->add(ComentarioPeer::RESPUESTA, $this->respuesta);
	...
	{
		$criteria = new Criteria(ComentarioPeer::DATABASE_NAME);
		$criteria->add(ComentarioPeer::COMENTARIO_ID, $this->comentario_id);
	...
	/**
	 * Generic method to set the primary key (comentario_id column).
	 *
	...
	{
		return null === $this->getComentarioId();
	}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setNew(true);
		$copyObj->setComentarioId(NULL); // this is a auto-increment column, so set to default value
	}
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addComentarios($this);
			 */
		}
	...
	public function getPost(PropelPDO $con = null)
	{
		if ($this->aPost === null && ($this->post_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPost->addComentarios($this);
			 */
		}
		return $this->aPost;
	}
