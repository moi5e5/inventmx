...
abstract class BasesfGuardUserProfilePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('SfGuardUserProfileId', 'UserId', 'Name', 'Lastname', 'Lastname2', 'Email', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('sfGuardUserProfileId', 'userId', 'name', 'lastname', 'lastname2', 'email', ),
		BasePeer::TYPE_COLNAME => array (self::SF_GUARD_USER_PROFILE_ID, self::USER_ID, self::NAME, self::LASTNAME, self::LASTNAME2, self::EMAIL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('SF_GUARD_USER_PROFILE_ID', 'USER_ID', 'NAME', 'LASTNAME', 'LASTNAME2', 'EMAIL', ),
		BasePeer::TYPE_FIELDNAME => array ('sf_guard_user_profile_id', 'user_id', 'name', 'lastname', 'lastname2', 'email', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('SfGuardUserProfileId' => 0, 'UserId' => 1, 'Name' => 2, 'Lastname' => 3, 'Lastname2' => 4, 'Email' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('sfGuardUserProfileId' => 0, 'userId' => 1, 'name' => 2, 'lastname' => 3, 'lastname2' => 4, 'email' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::SF_GUARD_USER_PROFILE_ID => 0, self::USER_ID => 1, self::NAME => 2, self::LASTNAME => 3, self::LASTNAME2 => 4, self::EMAIL => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('SF_GUARD_USER_PROFILE_ID' => 0, 'USER_ID' => 1, 'NAME' => 2, 'LASTNAME' => 3, 'LASTNAME2' => 4, 'EMAIL' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('sf_guard_user_profile_id' => 0, 'user_id' => 1, 'name' => 2, 'lastname' => 3, 'lastname2' => 4, 'email' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn($alias . '.SF_GUARD_USER_PROFILE_ID');
			$criteria->addSelectColumn($alias . '.USER_ID');
			$criteria->addSelectColumn($alias . '.NAME');
			$criteria->addSelectColumn($alias . '.LASTNAME');
			$criteria->addSelectColumn($alias . '.LASTNAME2');
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(sfGuardUserProfilePeer::SF_GUARD_USER_PROFILE_ID);
			if ($value) {
				$selectCriteria->add(sfGuardUserProfilePeer::SF_GUARD_USER_PROFILE_ID, $value, $comparison);
			} else {
